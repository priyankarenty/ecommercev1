...
class Product(models.Model):
	...
	HardDiskStorage			= models.CharField(max_length=100,null=True, blank=True)
	OS 						= models.CharField(max_length=100,null=True, blank=True)
	Processor 				= models.CharField(max_length=100,null=True, blank=True)
	TouchScreen 			= models.CharField(max_length=100,null=True, blank=True)
	ScreenSize 				= models.CharField(max_length=100,null=True, blank=True)
	ScreenBorder 			= models.CharField(max_length=100,null=True, blank=True)
	...
	def get_absolute_url(self):
		return "/products/hardware/{slug}/".format(slug=self.slug)

	class Meta:
		verbose_name = 'Data Upload for Hardware'
