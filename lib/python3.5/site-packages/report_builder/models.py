...
class Report(models.Model):
    ...
    root_model = models.ForeignKey(
        ContentType, limit_choices_to=get_limit_choices_to_callable,on_delete=models.DO_NOTHING)
    created = models.DateField(auto_now_add=True)
    modified = models.DateField(auto_now=True)
    user_created = models.ForeignKey(
        AUTH_USER_MODEL, editable=False, blank=True, null=True,on_delete=models.DO_NOTHING)
    user_modified = models.ForeignKey(
        AUTH_USER_MODEL, editable=False, blank=True, null=True,
        related_name="report_modified_set",on_delete=models.DO_NOTHING)
...
class DisplayField(AbstractField):
    ...
    display_format = models.ForeignKey(Format, blank=True, null=True,on_delete=models.DO_NOTHING)
